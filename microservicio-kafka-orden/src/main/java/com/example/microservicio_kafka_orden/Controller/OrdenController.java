package com.example.microservicio_kafka_orden.Controller;

import com.example.microservicio_kafka_base.DTO.Orden;
import com.example.microservicio_kafka_base.DTO.OrdenEvento;
import com.example.microservicio_kafka_orden.Kafka.ProductorOrden;
...
public class OrdenController {
    ...
    public String recibirOrden(@RequestBody Orden orden){
        ...
        ordenEvento.setMensaje("Estado de la orden está en pendiente");
