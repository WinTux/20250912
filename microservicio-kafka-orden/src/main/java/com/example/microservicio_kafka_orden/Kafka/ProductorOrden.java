package com.example.microservicio_kafka_orden.Kafka;
...
public class ProductorOrden {
    ...
    public void enviarMensaje(OrdenEvento evento){
        LOGGER.info(String.format("Evento de orden: %s", evento));
        Message<OrdenEvento> mensaje = MessageBuilder.withPayload(evento)
