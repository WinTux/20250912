package com.example.microservicio_kafka_email.kafka;
...
public class ConsumidorOrden {
    ...
    public void consumir(OrdenEvento ordenEvento){
        LOGGER.info(String.format("OrdenEvento recibido en el microservico email: %s", ordenEvento.toString()));
        // Enviaría un email al cliente
    }
}
